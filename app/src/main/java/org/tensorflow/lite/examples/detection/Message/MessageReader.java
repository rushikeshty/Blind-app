...
public class MessageReader extends AppCompatActivity implements TextToSpeech.OnUtteranceCompletedListener {
        ...
        textTospeech = new TextToSpeech(MessageReader.this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    textTospeech.setOnUtteranceCompletedListener(MessageReader.this);
    ...
    int[] grantResults) {
        ...
        if (requestCode == SMS_PERMISSION_REQUEST_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "SMS permission not granted, " + "restart the app ", Toast.LENGTH_SHORT).show();
